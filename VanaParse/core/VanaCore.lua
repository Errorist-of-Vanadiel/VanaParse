...
function Core.color_text(value, red, green, blue)
    ...
    local r,g,b=red,green or red,blue or red
    if Core.THEME=='light' then
        if r>=240 and g>=190 and b<=80 then r,g,b=155,95,0
        elseif g>=200 and r<=190 and b<=170 then r,g,b=0,120,35
        elseif r>=230 and g<=120 and b<=120 then r,g,b=175,25,25
        elseif r>=230 and g>=120 and g<200 and b<=90 then r,g,b=175,75,0
        elseif b>=180 and r<=160 then r,g,b=20,70,155 end
    end
    return ('\\cs(%d,%d,%d)%s\\cr'):format(r,g,b,tostring(value == nil and '' or value))
end
